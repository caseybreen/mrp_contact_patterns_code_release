...
google_mobility_data_2020 <- read_csv(here("data", "mrp", "input", "2020_US_Region_Mobility_Report.csv"), col_types = cols())
google_mobility_data_2021 <- read_csv(here("data", "mrp", "input", "2021_US_Region_Mobility_Report.csv"), col_types = cols())
...
## write out pca file
write_rds(google_mobility_data_pca, file = here("data", "mrp", "input", "google_mobility_pca.rds"))
```
