...
Plot one contact matrix for each month 
...
Compare our predictions to our actual survey results 
...
ggsave(plot = q_index_plots, height = 6, width = 12, file = here("figures", "q_index_plot.png"))
```
...
ggsave(plot = reproductive_values, height = 7, width = 17, file = here("figures", "reproductive_values_plot.png"))
```
