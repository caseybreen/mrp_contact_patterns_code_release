...
This script takes raw mobility mobility reports from Google (https://www.google.com/covid19/mobility/) creates a rolling 3 week average of the first principal component of the 7 measures. Specifically, 
...
```{r}
## prepared for model  
df_formodel <- read_rds(here('data', 'input', 'bics_data_waves_1-6_raw.rds')) %>% 
  filter(!is.na(state))
