---
title: "Fit MRP Models with Mobility Data"
author: Casey Breen
---

## Summary

This notebook contains code to fit two main hierarchical models: one model to estimate non-household contacts and one to model to estimate household contacts.
...
Recode stringency index and pca to 3-week rolling average  
...
Note: no mobility data used for within-household contacts 
...
<!-- Run main model non-hh model with Oxford Stringency Index (no gov response data) -->
