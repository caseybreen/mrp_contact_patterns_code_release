...
nonhh_model_gov_response_index <- brm(
  formula = mvbind(alter_age_0_18, alter_age_18_25, alter_age_25_35, alter_age_35_45, alter_age_45_55, alter_age_55_65, alter_age_65_100) ~ 
    ...
    weekday + 
    agecat:gender + 
    government_response_index + ## government response data 
...
write_rds(nonhh_model_stringency, file = here('data', 'models', 'nonhh_model_gov_response_index'))
```
