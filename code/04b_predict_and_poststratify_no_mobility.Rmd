...
## Non-Household Model
nonhh_model <- read_rds(file = here('data', 'models', 'nonhh_model_no_mobility.rds'))
...
make_predictions <- function(day, nonhh_model = nonhh_model, hh_model = hh_model, draws = 10){
  ...
  ## summarize post-stratify estimates 
  ...
  write_rds(x = newList, file = here('data', 'predictions_no_mobility', paste0('prediction_day', day, ".rds")))
